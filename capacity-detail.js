...
window.__CAPDETAIL = {
 ...
 "Ecological & Planetary Literacy": {
  ...
  "levels": {
   ...
   "Institutional": "Brings sound ecological science into real planning decisions for organisations or cities, helping choices reduce harm and support ecosystem health. Translates complex science into usable guidance for non-specialists.",
 ...
 "Narrative & Media Analysis": {
  ...
  "levels": {
   ...
   "Institutional": "Designs communication strategies and counter-narratives that shift how people and institutions actually behave, aligning diverse stakeholders behind a shared message. Builds trust and mobilises support through story.",
 ...
 "Data Analysis & Evaluation": {
  ...
  "levels": {
   ...
   "Institutional": "Builds measurement and evaluation systems that capture real social and environmental impact, not just whatever is easiest to count. Designs metrics that hold up to scrutiny and inform decisions.",
 ...
 "Experimenting & Building": {
  ...
  "levels": {
   ...
   "Institutional": "Secures the backing and resources to pilot new ventures or ways of working inside organisations. Designs portfolios of experiments so the system can learn while staying safe.",
 ...
 "Convening & Facilitating Collaborations": {
  ...
  "levels": {
   ...
   "Institutional": "Guides high-stakes meetings between groups that don't easily see eye to eye, holding tension long enough for shared direction to form. Designs collaborative processes, not just runs meetings.",
 ...
 "Conflict Transformation": {
  ...
  "levels": {
   ...
   "Institutional": "Mediates entrenched disputes between organisations or interests toward outcomes that genuinely work for everyone. Maps the actors and dynamics in a conflict and designs a path to repair.",
 ...
 "Ecosystem Engagement": {
  ...
  "levels": {
   ...
   "Institutional": "Manages partnerships across sectors — public, private, civic — aligning very different organisations and cultures around shared goals. Navigates the tensions that come with collaboration at scale.",
 ...
 "Advocacy & Political Participation": {
  ...
  "levels": {
   ...
   "Institutional": "Works with officials and lawmakers to write better standards and fairer rules into law and institutional practice. Translates community needs into durable policy.",
